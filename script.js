...
class App {
    ...
    _newWorkout(e) {
        ...
        // converted from string to number by using +
        ...
        if (type === 'running') {
            ...
            const cadence = +inputCadence.value;
             // Check if data is valid
            // We will use Guard clause - we will check for opposite of what we are interested in and if its true, we will return function.
            // if distance is not a number - return.
            // if(!Number.isFinite(distance) || !Number.isFinite(duration) || !Number.isFinite(cadence)) -- same as validInputs array 
